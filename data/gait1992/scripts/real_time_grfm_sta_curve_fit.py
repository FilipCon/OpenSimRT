...
experiment_grf_file = os.path.join(subject_dir, 'task_grf.mot')
...
grf_data = [grf_fx, grf_fy, grf_fz,
            grf_my]
curves = [sigmoid_with_bump, sigmoid_with_bump, sigmoid_with_bump,
          sigmoid_with_bump]
bibliography_curves = [anteriorSTA, componentSTA, componentSTA,
                       componentSTA]
titles = ['Anterior GRF', 'Vertical GRF', 'Lateral GRF',
          'Vertical GRM']
