...
/* light-weight wrapper classes to do resource management, and turn error codes
   into exceptions. This makes the client and server code easier to read. Be
   sure to run the server first.
...
class UDPSocket {
 public:
    ...
    void SendTo(const std::string& address, unsigned short port,
